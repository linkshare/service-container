...
Container.prototype.constructService = function constructService(id, isOptional, serviceTree) {
  ...
  if (typeof definition.class !== 'function' && !definition.isObject && typeof definition.class[definition.constructor] !== 'function') {
  ...
  if (definition.isObject) {
    ...
    svc = new definition.class[definition.constructor]();
    definition.class[definition.constructor].apply(svc, arguments);
  } else {
